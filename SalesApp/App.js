...
const App = () => {
  ...
  return (
    <NativeBaseProvider>
      <NavigationContainer>
          <Drawer.Navigator initialRouteName='StockAll' drawerContent={props => <CustomDrawer {...props}/>} screenOptions={{headerTitleAlign:"center",headerTitleStyle:{color:'#4F6367'},headerStyle:{height:70}}} >
